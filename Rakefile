...
desc 'Generate documentation for the shipping_centers extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ShippingCentersExtension'
...
desc 'Test the shipping_centers extension.'
...
namespace :test do
  desc 'Functional test the shipping_centers extension.'
  ...
  desc 'Unit test the shipping_centers extension.'
